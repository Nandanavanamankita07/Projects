...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Here, we fetch the data from the server
    fetch('http://localhost:5000/data/ocean_data.json') // Update the path to your local static data
      .then((response) => response.json())
      .then((data) => {
        setOceanData(data); // Set the fetched data in the state
      })
